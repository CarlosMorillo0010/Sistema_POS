...
=============================================*/
if(localStorage.getItem("capturarRangoDos") != null){
    $("#daterange-btn-reportes span").html(localStorage.getItem("capturarRangoDos"));
}else{
...
$('#daterange-btn-reportes').daterangepicker(
    ...
    function (start, end) {
        ...
        localStorage.setItem("capturarRangoDos", capturarRango);
...
$(".daterangepicker.opensright .range_inputs .cancelBtn").on("click", function(){
    localStorage.removeItem("capturarRangoDos");
    localStorage.clear();
...
$(".daterangepicker.opensright .ranges li").on("click", function(){
    ...
    if(textoHoy == "Hoy"){
        ...
        localStorage.setItem("capturarRangoDos", "Hoy");
        window.location = "index.php?ruta=reportes-ventas&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal;
    }
})