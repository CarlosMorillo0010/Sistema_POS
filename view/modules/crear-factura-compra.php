<div class="content-wrapper">
    ...
    <section class="content">
        <form class="formulario__FacturaCompra" role="form" method="post">
            <div class="box" style="border-top-color: #3c8dbc;">
                <div class="box-header with-border" style="text-align: end;display: flex;align-items: center;">
                    ...
                    $item = null;
                    $valor = null;
                    $facturaCompra = ControllerFacturasCompras::ctrMostrarFacturaCompra($item, $valor);

                    if (!$facturaCompra) {
                        $length = 10;
                        $string = "1";
                        echo '
                          <input type="text" style="color: red;font-weight: bold;font-size: 18px;width: 150px;background-color: transparent;height: 0px;border: 0;" class="form-control input-lg" name="nuevoCodigoFacturaCompra" id="nuevoCodigoFacturaCompra" readonly="readonly" value="' . str_pad($string, $length, 0, STR_PAD_LEFT) . '">';
                    } else {
                        foreach ($facturaCompra as $key => $value) {

                        }
                        $length = 10;
                        $codigo = str_pad($value["codigo"] + 1, $length, 0, STR_PAD_LEFT);
                        echo '<input type="text" style="color: red;font-weight: bold;font-size: 18px;width: 150px;background-color: transparent;height: 0px;border: 0;" class="form-control input-lg" name="nuevoCodigoFacturaCompra" id="nuevoCodigoFacturaCompra" readonly="readonly" value="' . $codigo . '">';
                    }
                    ?>
                </div>
                <div class="box-body">
                    <div class="col-lg-12">
                        <div class="form-group" style="display: flex;">
                            <div class="col-lg-2 input-group" style="margin: 0 10px 0 0;">
                                <label><small style="color: #000;">Nº de Pedido:</small></label>
                                <input type="text" class="form-control" name="numeroPedido" id="numeroPedido" required>
                            </div>
                            <div class="col-lg-2 input-group" style="padding-right: 10px;">
                                ...
                                <input type="date" class="form-control" name="fechaRegistro" id="fechaRegistro"
                                       value="<?php date_default_timezone_set('America/Caracas'); echo date('Y-m-d'); ?>" readonly required>
                            </div>
                            <div class="col-lg-2 input-group" style="margin: 0 10px 0 0;">
                                <label> <small style="color: #000;">Fecha de Vencimiento:</small></label>
                                <input type="text" class="form-control datepicker" name="fechaVencimiento" id="fechaVencimiento" style="padding-left: 12px;" required>
                            </div>
                            <div class="input-group" style="margin: 0 10px 0 0;">
                                <label></label>
                                <button type="button" class="btn btn-primary btnFCompra" style="width: 100%;">
                                    Agregar proveedor
                                </button>
                            </div>
                        ...
                        <div class="form-group FacturaCompra" style="display: flex;">

                        </div>
                        <input type="hidden" id="proveedorFC" name="proveedorFC" required>
                        <input type="hidden" id="proveedor_IDFC" name="proveedor_IDFC" required>
                    </div>
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="box-body" style="height: 230px; overflow: auto;">
                                <table class="table table-bordered">
                                    ...
                                    <tbody class="nuevaFacturaCompra">

                                    </tbody>
                                </table>
                                <input type="hidden" id="productosFC" name="productosFC" required>
                                <button type="button" class="btn btn-default btnProductoFC"
                ...
                <div class="box-footer">
                    <button class="btn btn-primary">Crear Factura de Compra</button>
                </div>
            </div>
        </form>
    </section>
...
<?php
$crearFacturaCompra = new ControllerFacturasCompras();
$crearFacturaCompra->ctrCrearFacturaCompra();
?>
                ...
                <div class="modal-body">
                    <div class="box-body">
                        ...
                        <div class="form-group col-lg-3 izquierda">
                            <div class="input-group">
                                <label style="color: red;"> * <small style="color: #000;">Municipio:</small>
                                    <select class="form-control input-lg" name="nuevoMunicipio" id="nuevoMunicipio" required>
                        ...
                        <div class="col-lg-6 izquierda">
                            <div class="form-group">
                                <div class="input-group">
                                    <label style="color: red;"> * <small style="color: #000;">Clasificación:</small></label>
