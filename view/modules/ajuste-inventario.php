...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Administrar Ajustes de Inventario
        </h1>
        <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-lg-6" style="padding-right: 0;">
                                ...
                                <div class="form-group col-lg-6">
                                    <div class="input-group">
                                        <label><small style="color: #000;">Almacén:</small>
                                            <select class="form-control input-lg" id="nuevoAlmacen" name="nuevoAlmacen">
                                ...
                                <div class="form-group col-lg-12">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control input-lg" name="nuevaDescripcion"
                                                  placeholder="Ingresar descripcion" style="resize: none;height: 130px;"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <form role="form" metohd="post" style="margin-top: -15px;">
                                    <div>
                                        <div class="with-border">
                                            <!--=====================================
                                            ENTRADA PARA AGREGAR AJUSTE DE INVENTARIO
                                            ======================================-->
                                            ...
                                            ======================================-->
                                            <div class="form-group row nuevoAjusteProducto">

                                            </div>
                                            <!--=====================================
                                            BOTÓN PARA AGREGAR PRODUCTO
                                            ======================================-->
                                            <button type="button" class="btn btn-default btnAjusteInventario"
                                                    style="margin-bottom: 15px;margin-left: 15px;">Agregar producto
                                            </button>
                                        </div>
                                    </div>
                                </form>
