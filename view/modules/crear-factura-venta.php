<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Factura de venta</li>
        </ol>
        ...
        <form class="formularioFacturaVenta" role="form" method="post">
            <div class="box" style="border-top-color: #3c8dbc;">
                <div class="box-header with-border" style="text-align: end;display: flex;align-items: center;">
                    ...
                    $item = null;
                    $valor = null;
                    $factura_venta = ControllerFacturaVentas::ctrMostrarFacturaVenta($item, $valor);
                    ...
                    if (!$factura_venta) {
                        ...
                        foreach ($factura_venta as $key => $value) {
                ...
                <div class="box-body">
                    <div class="col-lg-12">
                        <div class="form-group" style="display: flex;">
                            <div class="col-lg-4 input-group" style="margin: 0 10px 0 0;">
                                <label> <small style="color: #000;">Vendedor:</small>
                                    <input type="text" class="form-control" readonly="readonly" name="vendedorFactura"
                            ...
                            <div class="col-lg-2 input-group" style="padding-right: 10px;">
                                ...
                                <input name="fechaRegistro" type="date" class="form-control" readonly="readonly"
                                       value="<?php date_default_timezone_set('America/Caracas'); echo date('Y-m-d'); ?>">
                            </div>

                            <div class="input-group" style="margin: 0 10px 0 0;">
                                <label></label>
                                <button type="button" class="btn btn-primary btnClienteFacturaVenta" style="width: 100%;">
                                    Agregar Cliente
                                </button>
                            </div>
                        ...
                        <div class="form-group nuevoClienteFacturaVenta" style="display: flex;">
                        ...
                        <div class="row">
                            <div class="box-body" style="height: 230px; overflow: auto;">
                                <table class="table table-bordered">
                                    ...
                                    <tbody class="productoFacturaVenta">

                                    </tbody>
                                </table>
                                <input type="hidden" id="listaProductosFacturaVenta" name="listaProductosFacturaVenta">
                                <button type="button" class="btn btn-default btnFacturaVenta"
                        ...
                        <div>
                            <table class="table" border="0" style="margin-bottom: 0 !important;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 15%;">
                                        <input type="text" class="form-control" name="totalFacturaVenta" id="totalFacturaVenta" value="0.00" required readonly style="font-size: 30px;font-family: 'ds-digital'; color: #444;width: 100%;">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                ...
                <div class="box-footer">
                    <button class="btn btn-primary">Crear Factura de Venta</button>
                </div>
            </div>
        </form>
        <?php
        $crearFacturas = new ControllerFacturaVentas();
        $crearFacturas->ctrCrearFacturaVenta();
        ?>
    </section>
</div>
