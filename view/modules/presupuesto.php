                    ...
                    <?php
                        ...
                        foreach ($presupuestos as $key => $value) 
                        {
                            ...
                            echo '<tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button class="btn btn-dark btnVerPresupuesto" idPresupuesto="' . $value["id_presupuesto"] . '" data-toggle="modal" data-target="#modalVerPresupuesto"><i class="fa fa-eye"></i></button>                                  
                                        <button class="btn btn-warning btnEditarPresupuesto" idPresupuesto="' . $value["id_presupuesto"] . '" data-toggle="modal" data-target="#modalEditarPresupuesto"><i class="fa fa-pencil"></i></button>                                  
                                        <button class="btn btn-danger btnEliminarPresupuesto" idPresupuesto="' . $value["id_presupuesto"] . '"><i class="fa fa-times"></i></button>
                                    </div>
                                </td>
                            </tr>';
                        }
...
---------------------------------------->
<div id="modalVerPresupuesto" class="modal fade" role="dialog">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group" style="display: flex;">
                                ...
                                <div class="col-lg-2 input-group" style="padding-right: 10px;">
                                    ...
                                    <input type="date" name="verFechaVencimiento" id="verFechaVencimiento"
                                           class="form-control" readonly>
                                </div>
                            </div>
                            <!---------------------------------------
                    ...
                    <table class="table" border="0" style="margin-bottom: 0 !important;">
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 15%;">
                                    <input type="text" class="form-control" name="verTotalPresupuesto" id="verTotalPresupuesto" value="0.00" required readonly style="font-size: 30px;font-family: 'ds-digital'; color: #444;width: 100%;">
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
<div id="modalEditarPresupuesto" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg" style="width: 100%;padding-right: 17px;">
        <div class="modal-content">
                    ...
                    <div class="box-body">
                        <div class="col-lg-12">
                            <div class="form-group" style="display: flex;">
                                ...
                                <div class="col-lg-2 input-group" style="padding-right: 10px;">
                                    <label> <small style="color: #000;">Fecha de Emisión:</small></label>
                                    <input type="date" name="editarFechaEmision" id="editarFechaEmision"
                                           class="form-control" readonly>
                                </div>
                                <div class="col-lg-2 input-group" style="padding-right: 10px;">
                                    <label> <small style="color: #000;">Fecha de Vencimiento:</small></label>
                                    <input type="date" name="editarFechaVencimiento" id="editarFechaVencimiento"
                                           class="form-control" readonly>
                                </div>
                            </div>
                            <!---------------------------------------
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="text-align: center;width: 10%;">
                                                <input class="form-control editarCodigoProducto" name="editarCodigoProducto" id="editarCodigoProducto" readonly>
                                                </td>
                                                <td style="text-align: center;width: 25%;">
                                                <input class="form-control editarDescripcionProducto" name="editarDescripcionProducto" id="editarDescripcionProducto" readonly style="text-transform: uppercase;">
                                                </td>
                                                <td style="text-align: center;width: 10%;">
                                                <input class="form-control editarUnidadProducto" name="editarUnidadProducto" id="editarUnidadProducto" readonly style="text-transform: uppercase;">
                                                </td>
                                                <td style="text-align: center; width: 10%;">
                                                <input type="tex" class="form-control editarCantidadProducto" name="editarCantidadProducto" id="editarCantidadProducto" readonly>
                                                </td>
                                                <td style="text-align: center; width: 10%;">
                                                <input type="tex" class="form-control editarPrecioProducto" name="editarPrecioProducto" id="editarPrecioProducto" readonly>
                                                </td>
                                                <td style="text-align: center; width: 10%;">
                                                <input type="tex" class="form-control editarImpuestoProducto" name="editarImpuestoProducto" id="editarImpuestoProducto" readonly>
                                                </td>
                                                <td style="text-align: center; width: 10%;">
                                                <input type="tex" class="form-control editarTotalProducto" name="editarTotalProducto" id="editarTotalProducto" readonly>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <table class="table" border="0" style="margin-bottom: 0 !important;">
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 15%;">
                                    <input type="text" class="form-control" name="editarTotalPresupuesto" id="editarTotalPresupuesto" value="0.00" required readonly style="font-size: 30px;font-family: 'ds-digital'; color: #444;width: 100%;">
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <?php
            $editarPresupuesto = new ControllerPresupuestos();
            $editarPresupuesto->ctrEditarPresupuesto();
            ?>
        </div>
    </div>
</div>
<?php
$borrarPresupuesto = new ControllerPresupuestos();
