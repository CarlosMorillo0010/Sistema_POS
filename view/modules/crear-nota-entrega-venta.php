<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Nota de Entrega Venta
        </h1>
        <ol class="breadcrumb">
            <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li class="active">Nota de entrega venta</li>
        </ol>
        ...
        <form class="formulario__NotaEntregaVenta" role="form" method="post">
            <div class="box" style="border-top-color: #3c8dbc;">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group" style="display: flex;">
                            <div class="col-lg-3 input-group" style="margin: 0 10px 0 0;">
                                ...
                                <input type="text" class="form-control" name="nuevoNumeroRecepcionVenta"
                                       id="nuevoNumeroRecepcionVenta" required>
                            </div>
                            <div class="col-lg-3 input-group" style="margin: 0 10px 0 0;">
                            ...
                            <div class="col-lg-3 input-group" style="padding-right: 10px;">
                                ...
                                <input type="date" class="form-control" name="nuevaFechaNota"
                                       id="nuevaFechaNota" value="<?php date_default_timezone_set('America/Caracas'); echo date('Y-m-d'); ?>">
                            </div>
                            <div class="col-lg-3 input-group" style="margin: 0 10px 0 0;">
                                <label> <small style="color: #000;">Fecha de Registro:</small></label>
                                <input type="text" class="form-control datepicker" name="nuevaFechaRegistro"
                                       id="nuevaFechaRegistro">
                            </div>
                            <div class="input-group" style="margin: 0 10px 0 0;">
                                <label></label>
                                <button type="button" class="btn btn-primary btnNotaEntregaVenta" style="width: 100%;">
                                    Agregar Cliente
                                </button>
                            </div>
                        ...
                        <div class="ClienteNotaEntregaVenta" style="display: flex;">
                        ...
                        <div class="row">
                            <div class="box-body" style="height: 250px; overflow: auto;">
                                <table class="table table-bordered">
                                    ...
                                    <tbody class="productosNotaEntregaVenta">

                                    </tbody>
                                </table>
                                <input type="hidden" id="listarProductos" name="listarProductos">
                                <button type="button" class="btn btn-default btnproductoNotaEntregaVenta"
                        ...
                        <div>
                            <table class="table" border="0" style="margin-bottom: 0 !important;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 15%;">
                                        <input type="text" class="form-control" name="total__notaEntregaVenta" id="total__notaEntregaVenta" value="0.00" required readonly style="font-size: 30px;font-family: 'ds-digital'; color: #444;width: 100%;">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                ...
                <div class="box-footer">
                    <button class="btn btn-primary">Crear Nota de Entrega</button>
                </div>
            </div>
        </form>
    </section>
...
<?php
$crearNotaEntregaVentas = new ControllerNotasEntregaVentas();
$crearNotaEntregaVentas->ctrCrearNotaEntregaVenta();
?>
